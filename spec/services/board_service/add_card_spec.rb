...
describe 'add feature to board' do
  ...
  context 'no state phase no wip limit' do
    ...
    it do
      feature_id = Feature::FeatureId.new('feat_1')
  ...
  context 'no state phase, wip limit = 3' do
    ...
    context 'wip = 2' do
      it do
        ...
        service.add_card(project_id, Feature::FeatureId.new('feat_2'))
        service.add_card(project_id, Feature::FeatureId.new('feat_3'))
        service.add_card(project_id, feature_id)
    ...
    context 'wip = 3' do
      it do
        ...
        service.add_card(project_id, Feature::FeatureId.new('feat_2'))
        service.add_card(project_id, Feature::FeatureId.new('feat_3'))
        service.add_card(project_id, Feature::FeatureId.new('feat_4'))
        expect {
          service.add_card(project_id, feature_id)
