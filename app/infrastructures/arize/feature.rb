module Arize
  module Feature
    ...
    included do
      ...
      has_one :development_feature_record, foreign_key: 'feature_record_id', dependent: :destroy
    ...
    module Writers
      ...
      def log_development
        build_development_feature_record(start_at: Time.current)
      end
